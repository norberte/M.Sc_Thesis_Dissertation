\chapter{Results\label{chap:result}}
    ...
    \section{Expertise Extraction\label{sec:results_rq1}}
        ...
        %16	[0.05 0.05 0.05 ]	0.012673993	0.014390791	0.7679698
        %16	[0.01 0.01 0.01 ]	0.012214386	0.013788219	0.7671518
        %16	[0.001 0.001 0.001]	0.011640888	0.013062798	0.7670858
    ...
    \section{Expertise Evolution\label{sec:results_rq4}}
        ...
        Figure \ref{fig:SO_past_recent} and \ref{fig:change_SO_past_recent} show the results of comparing the past and recent activity of users on Stack Overflow. For the rest of the analysis this will be referred to as the \emph{SO past-recent} comparison. %% continue here
