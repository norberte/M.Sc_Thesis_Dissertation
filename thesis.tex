...
% for this package.
\usepackage[3committee]{cuthesis}
\usepackage{makecell}
...
\newcommand{\Edited}[1]{\textcolor{green}{{\it [New Edit: #1]}}}
...
\supervisor{Dr. Olga Baysal, Thesis Supervisor}
\firstcommittee{Dr. Majid Komeili, Internal Examiner}
\secondcommittee{Dr. Diana Inkpen, External Examiner}
%\thirdcommittee{Dr. Ahmed El-Roby, Chair of Defense}

% Specify department chair
\departmentchair{Dr. Michel Barbeau, Department Chair}
