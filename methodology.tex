...
Section~\ref{sec:algo_design}, being the largest section of methodology, describes what algorithms are designed in order to extract expertise insights from data. Last, Section~\ref{sec:tools} contains a detailed overview of all the software tools used.
